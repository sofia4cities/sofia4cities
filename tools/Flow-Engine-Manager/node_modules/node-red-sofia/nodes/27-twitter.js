...
module.exports = function(RED) {
    ...
    function TwitterInNode(n) {
        ...
        if (credentials && credentials.screen_name == this.twitterConfig.screen_name) {
            var twit = new Ntwitter({
                consumer_key: "PrKhwISsziTFETSsHcV6aSCRQ",
                consumer_secret: "XEwlqWCdUgcZG7qqc9fY1pNMQCCvfDBQPm4CgEGhg5CPI61pza",
    ...
    var oa = new OAuth(
        ...
        "PrKhwISsziTFETSsHcV6aSCRQ",
        "XEwlqWCdUgcZG7qqc9fY1pNMQCCvfDBQPm4CgEGhg5CPI61pza",
        "1.0",
        null,
        "HMAC-SHA1"
    );
