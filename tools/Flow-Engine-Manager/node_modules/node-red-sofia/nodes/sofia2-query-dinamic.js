...
module.exports = function(RED) {
	...
	function LoadQuery(n) {
		...
		this.on('input', function(msg) {
			...
			var endpoint = sofia2Config.scriptBasePath + "/sofia2/flowengine/node/services/user/query?ontology=" + ontology + "&targetDB=" + targetDB + "&queryType=" + queryType + "&query=" + query + "&authentication=" + n.authentication;
