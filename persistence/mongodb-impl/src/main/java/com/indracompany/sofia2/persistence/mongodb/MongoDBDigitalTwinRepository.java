...
@Component("MongoDBDigitalTwinRepository")
@Scope("prototype")
@Lazy
@Slf4j
public class MongoDBDigitalTwinRepository implements BasicOpsDBRepository {
	@Autowired
	...
	@Value("${sofia2.database.mongodb.digitaltwin.database:#{null}}")
	@Getter
	@Setter
