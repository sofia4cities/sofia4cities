...
public class OperationModel implements Serializable{
	...
	@Getter final private String ontologyName;
	@Getter	final private OperationType operationType;
	@Getter	final private String user;
	@Getter final private Source source;
	
	//optional attributes
	@Getter	private String body;
	@Getter	private QueryType queryType;
	@Getter private String objectId;
	@Getter private String clientPlatformId;
	@Getter private String clientPlatoformInstance;
	@Getter private String clientSession;
	@Getter private String clientConnection;
	@Getter	private boolean cacheable=false;

	@Override
	public String toString() {
		return new StringBuilder()
				.append("OperationModel [ontologyName=").append(ontologyName)
				...
				.append(", clientPlatformId=").append(clientPlatformId)
				.append(", clientPlatformInstance=").append(clientPlatoformInstance)
				.append(", clientSession=").append(clientSession)
				.append(", clientConnection=").append(clientConnection)
				.append(", cacheable=").append(cacheable)
				.append("]")
				.toString();
	}
	...
	public static Builder builder(String ontologyName, 
