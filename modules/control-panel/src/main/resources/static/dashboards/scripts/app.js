...
$templateCache.put('app/partials/edit/addWidgetBottomSheet.html','<md-bottom-sheet class="md-grid addGadget-sheet" layout=column><div layout=row style="margin-top: -25px;" layout-align="center center" ng-cloak><h5 class=addGadget-title><md-icon class="ng-scope material-icons addGadget-title-icon" role=img aria-label=add_circle_outline>add_circle_outline</md-icon>Drag&Drop your gadget to the grid panel</h5></div><div ng-cloak><div layout=row layout-align="center center" layout-wrap style="margin-bottom: 15px;  margin-top: -10px;"><div flex=12><md-button id=line draggable><md-icon class=addGadget-icon>show_chart</md-icon><div class="md-grid-text bold">Line Chart</div></md-button></div><div flex=12><md-button id=bar draggable><md-icon class=addGadget-icon>insert_chart</md-icon><div class="md-grid-text bold">Bar Chart</div></md-button></div><div flex=12><md-button id=pie draggable><md-icon class=addGadget-icon>pie_chart</md-icon><div class="md-grid-text bold">Pie Chart</div></md-button></div><div flex=12><md-button id=wordcloud draggable><md-icon class=addGadget-icon>sort_by_alpha</md-icon><div class="md-grid-text bold">Wordcloud</div></md-button></div><div flex=12><md-button id=map draggable><md-icon class=addGadget-icon>map</md-icon><div class="md-grid-text bold">Map</div></md-button></div><div flex=12><md-button id=radar draggable><md-icon class=addGadget-icon>track_changes</md-icon><div class="md-grid-text bold">Radar</div></md-button></div><div flex=12><md-button id=livehtml draggable><md-icon class=addGadget-icon>art_track</md-icon><div class="md-grid-text bold">Live HTML</div></md-button></div><div flex=12><md-button id=table draggable><md-icon class=addGadget-icon>view_list</md-icon><div class="md-grid-text bold">Table</div></md-button></div></div></div></md-bottom-sheet>');
...
$templateCache.put('app/components/view/elementComponent/element.html','<gridster-item item=vm.element ng-style="{\'background-color\':vm.element.backgroundColor, \'border-width\': vm.element.border.width + \'px\', \'border-color\': vm.element.border.color, \'border-radius\': vm.element.border.radius + \'px\', \'border-style\': \'solid\', \'box-shadow\': \'rgba(113, 106, 202, 0.08) 0px 1px 15px 1px\'}"><div class="element-container fullcontainer"><md-toolbar ng-if=vm.element.header.enable class="widget-header md-hue-2" ng-style="{\'background\':vm.element.header.backgroundColor, \'height\': vm.element.header.height + \'px\'}"><div class=md-toolbar-tools><md-icon ng-style="{\'color\':vm.element.header.title.iconColor,\'font-size\' : \'20px\'}">{{vm.element.header.title.icon}}</md-icon><h5 flex ng-style="{\'color\':vm.element.header.title.textColor}" md-truncate>{{vm.element.header.title.text}}</h5><md-icon class=cursor-hand style="font-size: 18px;color: hsl(220, 5%, 69%);" ng-if=vm.datastatus tooltips tooltip-show-trigger=click tooltip-hide-trigger=click tooltip-close-button=true tooltip-size=small tooltip-template-url=app/partials/view/filterTooltip.html ng-attr-tooltip-side="{{vm.editmode?\'bottom\':\'bottom left\'}}">filter_list</md-icon><md-button ng-if=vm.editmode ng-click=vm.openEditContainerDialog() class=md-icon-button aria-label="Edit Container"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">format_paint</md-icon><md-tooltip>Edit container</md-tooltip></md-button><md-button ng-if="vm.editmode && vm.element.type == \'livehtml\'" ng-click=vm.openEditGadgetDialog() class=md-icon-button aria-label="Gadget Editor"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">mode_edit</md-icon><md-tooltip>Edit Gadget definition</md-tooltip></md-button><md-button ng-if=vm.editmode class="drag-handler md-icon-button"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">open_with</md-icon><md-tooltip>Move</md-tooltip></md-button><md-button ng-if=vm.editmode class="remove-button md-icon-button" ng-click=vm.deleteElement()><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">delete</md-icon><md-tooltip>Remove</md-tooltip></md-button></div></md-toolbar><div ng-if="vm.editmode && !vm.element.header.enable" class=item-buttons><md-button ng-click=vm.openEditContainerDialog() class=md-icon-button aria-label="Edit Container"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">format_paint</md-icon></md-button><md-button ng-click=vm.openEditGadgetDialog() ng-if="vm.element.type == \'livehtml\'" class=md-icon-button aria-label="Gadget Editor"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">mode_edit</md-icon></md-button><md-button ng-if=vm.editmode class="drag-handler md-icon-button"><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">open_with</md-icon></md-button><md-button ng-if=vm.editmode class="remove-button md-icon-button" ng-click=vm.deleteElement()><md-icon style="font-size: 18px;color: hsl(220, 5%, 69%);">delete</md-icon><md-tooltip>Remove</md-tooltip></md-button></div><livehtml ng-style="{\'background-color\':vm.element.backgroundColor, \'padding\': vm.element.padding + \'px\', \'height\': vm.calcHeight()}" ng-if="vm.element.type == \'livehtml\'" livecontent=vm.element.content datasource=vm.element.datasource ng-class=vm.element.id id=vm.element.id datastatus=vm.datastatus></livehtml><gadget ng-style="{\'background-color\':vm.element.backgroundColor,\'margin\': \'15px 0px 10px 0px\', \'padding\': vm.element.padding + \'px\', \'display\': \'inline-block\', \'width\': \'calc(100% - 20px)\', \'position\': \'absolute\',\'top\': \'50%\',\'left\': \'50%\',\'transform\': \'translate(-50%, -50%)\',\'height\': vm.calcHeight()}" ng-if="vm.element.type != \'livehtml\'" ng-class=vm.element.id id=vm.element.id datastatus=vm.datastatus></gadget></div></gridster-item>');
