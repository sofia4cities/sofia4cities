var dataModelCreateController  = function(){
	...
	$("#createBtn").on('click',function(){
		...
		if($("#datamodelName").val()!='' && $("#datamodelName").val()!=undefined && $("#datamodelDescription").val()!='' && $("#datamodelDescription").val()!=undefined) {
			...
			$.alert({title: 'ERROR!', theme: 'dark', type: 'red', content: dataModelCreateJson.validform.emptyfields});
			return false;
		}
	...
	$("#updateBtn").on('click',function(){
		...
		if($("#datamodelName").val()!='' && $("#datamodelName").val()!=undefined && $("#datamodelDescription").val()!='' && $("#datamodelDescription").val()!=undefined){
			...
			$.alert({title: 'ERROR!', theme: 'dark', type: 'red', content: dataModelCreateController.validform.emptyfields});
			return false;
		}
