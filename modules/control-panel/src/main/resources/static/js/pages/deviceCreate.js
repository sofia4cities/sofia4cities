				...
				$('#datamodel_tokens > tbody')
						.append(
								'<tr data-id="'
										...
										+ '"><td>'
										+ token.token
										+ '</td><td><input class="form-check-input" type="checkbox" onclick="DeviceCreateController.changeEstatusToken(this);" value="'
										+ token.active
										+ '" '
										+ checked
										+ '></td><td class="icon" style="white-space: nowrap"><div class="grupo-iconos"><button   id="deleteBtn" type="button" class="btn btn-square btn-danger" name="delete"  value="Remove" onclick="DeviceCreateController.showConfirmDialogDeleteToken(this);" ><i class="la la-trash"></i> <span th:text="#{gen.deleteBtn}"> Delete </span></button></div></td></tr>');
			}
		}
	}
