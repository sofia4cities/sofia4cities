...
public class UpdateProcessorTest {
	...
	public void setUp() throws IOException, Exception {
		...
		subjectInsertResult = repository.insert(Person.class.getSimpleName(), objectMapper.writeValueAsString(subject));
	...
	@Test
	public void test_update_by_nont_existent_id() {
