...
public class DashboardUserAccessTypeRepositoryIntegrationTest {
	...
	@Before
	public void setUp() {
		List<DashboardUserAccessType> types = this.repository.findAll();
		if (types.isEmpty()) {
	...
	@Test
	public void given_SomeDashboardUserAccessesExist_When_ItIsSearchedById_Then_TheCorrectObjectIsObtained() {
