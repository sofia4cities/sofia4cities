...
public class DashboardServiceImpl implements DashboardService{
	...
	public void saveDashboard(String id, Dashboard dashboard, String userId) {
		if (hasUserPermission(id, userId)) {
			...
			throw new GadgetDatasourceServiceException("Cannot update Dashboard that does not exist or don't have permission");
	}
