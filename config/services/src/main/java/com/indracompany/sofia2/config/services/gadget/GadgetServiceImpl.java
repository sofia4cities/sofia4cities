...
public class GadgetServiceImpl implements GadgetService {
	...
	public List<Gadget> findGadgetWithIdentificationAndDescription(String identification, String description,
		...
		if (user.getRole().getName().equals(GadgetServiceImpl.ADMINISTRATOR)) {
			if (description != null && identification != null) {
				...
				gadgets = this.gadgetRepository.findByIdentificationContainingAndDescriptionContaining(identification,
						description);
			...
			if (description != null && identification != null) {
				...
				gadgets = this.gadgetRepository.findByUserAndIdentificationContainingAndDescriptionContaining(user,
	...
	public Gadget getGadgetById(String userID, String gadgetId) {
		...
		// gadget.getUser().getUserId().equals(userID)) {
		return gadget;
		// }
		// return null;
	}
