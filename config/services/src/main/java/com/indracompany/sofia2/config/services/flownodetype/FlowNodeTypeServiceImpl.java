 ...
 */
package com.indracompany.sofia2.config.services.flownodetype;
...
public class FlowNodeTypeServiceImpl implements FlowNodeTypeService {
	...
	@Override
	public List<FlowNodeType> getAllFlowNodeTypes() {
		return nodeTypeRepository.findAll();
	}

	@Override
	public FlowNodeType getByIdentification(String identification) {
		return nodeTypeRepository.findByIdentification(identification);
	}
